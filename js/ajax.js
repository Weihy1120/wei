...
function ajaxUrl(music, callback)
{
    ...
    $.ajax({ 
        ...
        success: function(jsonData){
            ...
            } else if (music.source == "tencent") {
                jsonData.url = jsonData.url.replace("https://dl.stream.qqmusic.qq.com/M800", "https://dl.stream.qqmusic.qq.com/M500");
            }
...
function getUserInfo(token, callback) {
    $.ajax({
        type: 'POST',
        url: apphost + "/api/user/findByUser",
        dataType: 'json',
        headers: {
...
function checkAu(token, callback) {

    $.ajax({
        type: 'POST',
        url: apphost + "/api/user/checkAuth",
        dataType: 'json',
        headers: {
            'Authorization': token.replace(/[\r\n]/g, "")
        },
...
function checkAu2(token, singer, song, album, callback) {

    $.ajax({
        type: 'POST',
        url: apphost + "/api/user/checkAuth2",
        dataType: 'json',
        headers: {
            'Authorization': token.replace(/[\r\n]/g, "")
        },
        ...
        contentType: "application/json;charset=utf-8",
        data: JSON.stringify({ 'token': token, 'singer': singer, 'album': album, 'song': song }),
        success: function (data) {
            callback(data);
        }
    });
...
function checkBlack(singer, song, album, callback, errcallback) {

    $.ajax({
        type: 'POST',
        url: apphost + "/api/user/checkBlackList",
        dataType: 'json',
        xhrFields: {
            withCredentials: true
        },
        contentType: "application/json;charset=utf-8",
        data: JSON.stringify({ 'singer': singer, 'song': song, 'album': album }),
        success: function (data) {
            callback(data);
        },
        error: function () {
...
function createOrder(token, param, callback) {
    $.ajax({
        type: 'POST',
        url: apphost + '/api/v2/orders/create',
        dataType: 'json',
        headers: {
            'Authorization': token.replace(/[\r\n]/g, "")
        },
...
function listProduct(token, callback) {
    $.ajax({
        type: 'POST',
        url: apphost + '/api/v2/orders/listProduct',
        dataType: 'json',
        headers: {
            'Authorization': token.replace(/[\r\n]/g, "")
        },
...
function findPayOrder(id, token, callback) {
    $.ajax({
        type: 'GET',
        url: apphost + '/api/v2/orders/find/' + id,
        dataType: 'json',
        headers: {
            'Authorization': token.replace(/[\r\n]/g, "")
        },
...
function findAccount(orderid, callback) {
    $.ajax({
        type: 'GET',
        url: apphost + '/api/user/findAccount/' + orderid,
        dataType: 'json',
        xhrFields: {
            withCredentials: true
        },
